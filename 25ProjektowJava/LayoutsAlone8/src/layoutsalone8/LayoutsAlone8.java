 ...
 * @author finito
 */
public class LayoutsAlone8 extends JFrame{
    ...
    public LayoutsAlone8()
    {
        this.setBounds(7, 7, 900, 800);
        initComponents();
    ...
    public void initComponents()
    {
        ...
        layout.setHorizontalGroup(
                ...
                .addGroup(
                        layout.createParallelGroup().addComponent(b6).addComponent(b14)
                )
                .addGroup(
                        layout.createParallelGroup().addComponent(b7)
                )
                .addGroup(
                        layout.createParallelGroup().addComponent(b33).addComponent(b16)
                )
                .addGroup(
                        layout.createParallelGroup().addComponent(b1).addComponent(b17)
                )
                .addGroup(
                        layout.createParallelGroup().addComponent(b44)
                                
                )
                .addGroup(
                        layout.createParallelGroup().addComponent(b3).addComponent(b11).addComponent(b19)
                )
                .addGroup(
                        layout.createParallelGroup().addComponent(b45).addComponent(b21).addComponent(b30)
                )
                .addGroup(
                        layout.createParallelGroup().addComponent(b12)
                )
                .addGroup(
                        layout.createParallelGroup().addComponent(b47).addComponent(b48)
                )
                .addGroup(
                        layout.createParallelGroup().addComponent(b5)
                )
        ...
        layout.setVerticalGroup(
                layout.createSequentialGroup()
                .addGroup(
                        layout.createParallelGroup().addComponent(b33).addComponent(b1).addComponent(b44).addComponent(b3).addComponent(b45).addComponent(b5)
                )
                .addGroup(
                        layout.createParallelGroup().addComponent(b6).addComponent(b7).addComponent(b11).addComponent(b12).addComponent(b47)
                )
                .addGroup(
                        layout.createParallelGroup().addComponent(b14).addComponent(b16).addComponent(b17).addComponent(b19).addComponent(b21).addComponent(b48)
                )
    ...
    public static void main(String[] args) {
        ...
        new LayoutsAlone8().setVisible(true);
    }
